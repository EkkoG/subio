    ...
    variants.append(
        {
            ...
            "skip-cert-verify": True,
            "network": "h2",
            "h2-opts": {"path": "/h2", "host": ["example.com"]},
        }
    )
    ...
    variants.append(
        {
            ...
            "psk": "yourpsk",
            "version": 3,
            "obfs-opts": {"mode": "tls", "host": "example.com"},
        }
    )
...
def generate_http_socks_variants() -> List[Dict[str, Any]]:
    ...
    # HTTP without auth
    variants.append(
        {"name": "http-basic", "type": "http", "server": "1.2.3.4", "port": 8080}
    )
    ...
    # SOCKS5 without auth
    variants.append(
        {"name": "socks5-basic", "type": "socks5", "server": "1.2.3.4", "port": 1080}
    )
    ...
    variants.append(
        {
            ...
            "password": "password123",
            "network": "quic",
            "quic-opts": {"security": "chacha20-poly1305", "key": "password123"},
        }
    )
...
def main():
        ...
        "proxy-groups": [
            ...
            },
            {
                ...
                "proxies": [
                    ...
                    if p["type"] in ["hysteria", "hysteria2"]
                ],
            },
            {
                "name": "WireGuard",
            ...
            },
            {
                ...
                "type": "select",
                "proxies": [
                    p["name"] for p in all_proxies if p["type"] in ["http", "socks5"]
                ],
            },
            {
    ...
    print(
        f"Generated mihomo_all_protocols.yaml with {len(all_proxies)} proxy configurations"
    )
